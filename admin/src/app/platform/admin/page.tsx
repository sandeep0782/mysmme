...
const AdminDashboard = () => {
    ...
    const activeBrandCount = brands.filter(
        (brand) => brand.isActive
    ).length;
    const inactiveBrandCount = brands.filter(
        (brand) => !brand.isActive
    ).length;
    ...
    const activeColorsCount = colors.filter(
        (color) => color.isActive
    ).length;
    const inactiveColorsCount = colors.filter(
        (color) => !color.isActive
    ).length;
            ...
            <main className="px-4 py-2">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-slate-500">
                        Manage users, sellers, freelancers, products,
