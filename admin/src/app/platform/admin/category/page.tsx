...
const Page = () => {
  ...
  const filteredCategories = !searchValue
    ...
    : categories.filter((category) => {
        ...
        const shortDescription = category.shortDescription.toLowerCase() ?? "";
  ...
  const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!ALLOWED_IMAGE_TYPES.includes(file.type)) {
      setSaveError("Only PNG, JPG, JPEG, and WebP images are allowed.");
    ...
    if (file.size > MAX_IMAGE_SIZE) {
      setSaveError("Category image must be smaller than 5MB.");
  ...
  const onSubmitCategory = async (data: CategoryFormData) => {
    ...
    try {
      ...
      if (!editingCategory && !imageFile) {
        setSaveError("Category image is required.");
        ...
        <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
              Create and manage categories used to organize your product
              catalog.
            </p>
          </div>
                ...
                <tbody className="divide-y divide-slate-100">
                  {paginatedCategories.map((category) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-6 py-5">
                        <span
                          className={`inline-flex w-[88px] items-center justify-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold ${
                            category.isActive
              ...
              <div className="space-y-5 px-6 py-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`h-11 w-full rounded-lg border bg-white px-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-50 ${
                      errors.name
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="ml-2 text-xs font-normal text-slate-400">
                      (for search results — keep it under 160 characters)
                    </span>
                  </label>
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="e.g. Shop Office Wear sarees — lightweight cotton, linen & soft silk in polished, everyday-ready tones for work."
                    disabled={isSaving}
                    ...
                    className={`w-full resize-none rounded-lg border bg-white px-3 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-50 ${
