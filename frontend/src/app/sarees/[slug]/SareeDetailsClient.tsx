...
interface SareeDetailsClientProps {
  saree: SareeProduct;
}

const SareeDetailsClient = ({ saree }: SareeDetailsClientProps) => {
  ...
  const handleAddToWishlist = async (productId: string) => {
    try {
      ...
      const errorMessage = error?.data?.message || "Wishlist action failed";
      const status = error?.status;
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <Link
                  ...
                  className="text-lg font-bold uppercase text-red-500 hover:underline"
                >
                  {saree.brand?.name ?? ""}
                </Link>
              </div>
              ...
              {/* Title */}
              <div>
                <h1 className="font-semibold leading-tight text-zinc-500 md:text-xl">
                  {saree.title}
                </h1>
              </div>
                ...
                <div className="border-t pt-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {relatedColors.map((item) => (
                      <Link
                        key={item._id}
                        href={`/sarees/${item.slug ?? item._id}`}
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex w-full cursor-pointer items-center justify-center rounded-sm bg-red-500 px-6 py-4 text-sm font-semibold text-white transition hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {isAddToCart ? (
                    <>
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-semibold uppercase text-gray-900">
                      {typeof saree.seller === "object" && saree.seller !== null
                        ? saree.seller.name || "-"
                        : "-"}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="cursor-pointer text-sm font-semibold text-red-500 transition-colors hover:text-red-600 hover:underline"
                  >
          ...
          >
            ...
            <div className="border-t px-5 py-3">
              <button
                type="button"
                onClick={() => setIsSupplierModalOpen(false)}
                className="w-full cursor-pointer rounded-sm bg-red-500 py-2.5 text-sm font-semibold text-white hover:bg-red-600"
              >
                Close
              </button>
            </div>
...
export default SareeDetailsClient;
