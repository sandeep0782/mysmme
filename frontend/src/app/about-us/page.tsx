...
const fullTitle = "About MYSMME | Indian Saree & Fashion Marketplace";
const description =
  "MYSMME is an Indian fashion marketplace connecting customers with saree sellers, boutiques, and designers. Learn our story and why we built a dedicated saree marketplace.";
...
const ABOUT_FAQS = [
  {
    ...
    answer:
      "MYSMME is an Indian fashion marketplace connecting customers with saree sellers, boutiques, designers, and fashion businesses. The platform is designed to make it easier to discover and shop for sarees and other Indian fashion products online.",
  },
  {
    question: "What can I buy on MYSMME?",
    answer:
      "MYSMME focuses on sarees and Indian fashion. Customers can discover traditional sarees, contemporary saree styles, festive and wedding collections, everyday sarees, ethnic wear, and other fashion products offered by marketplace sellers.",
  },
  {
    question: "Is MYSMME a saree marketplace?",
    answer:
      "Yes. Sarees are a core focus of MYSMME. The marketplace is being built to help customers discover sarees from different sellers while giving saree businesses a digital platform to showcase their collections.",
  },
  {
    question: "Who can sell on MYSMME?",
    answer:
      "MYSMME is designed for saree sellers, boutiques, designers, retailers, independent sellers, and Indian fashion businesses that want to showcase their products and reach customers through an online marketplace.",
  },
  {
    question: "Why was MYSMME created?",
    answer:
      "MYSMME was created to make Indian fashion easier to discover online and to help sellers reach customers beyond their immediate local markets. The broader vision is to build a digital ecosystem around Indian fashion and commerce.",
  },
  {
    question: "Where can I explore MYSMME products?",
    answer:
      "Customers can browse available products and collections through the MYSMME marketplace. Visit the products section to explore the current range of sarees and Indian fashion products.",
  },
];
  ...
  const aboutSchema = {
    ...
    mainEntity: {
      ...
      founder: {
        "@type": "Person",
        name: "Sandeep Kumar",
        sameAs: "https://www.linkedin.com/in/sandeep-kumar-182b8a23a/",
      },
    },
  };
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
            ...
            <div>
              ...
              <p className="mt-7 max-w-xl text-base leading-8 text-[#6f625c] sm:text-lg">
                MYSMME is an Indian fashion marketplace connecting customers
                with saree sellers, boutiques, fashion businesses, and
                independent sellers. Our goal is to make it easier to discover
                traditional and contemporary Indian clothing online.
              </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base leading-8 text-[#6f625c]">
              ...
              customers can use one marketplace to discover different
              collections, compare products, find new sellers, and shop for
              Indian fashion online.
            </p>

            <p className="mt-4 text-base leading-8 text-[#6f625c]">
              At the same time, MYSMME gives saree sellers, boutiques,
              designers, and Indian fashion businesses an opportunity to create
              an online presence and reach customers beyond their local market.
            </p>
          </div>
            ...
            <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
              <div>
                ...
                <p className="mt-6 text-base leading-8 text-[#6f625c]">
                  ...
                  colors, patterns, and regional styles. MYSMME aims to make
                  this variety easier to discover online.
                </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-7 text-[#6f625c]">
              MYSMME is designed around a simple marketplace model: sellers
              bring their products to the platform, and customers discover
              collections from different businesses in one place.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-24">
            ...
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-[#6f625c]">
                ...
                from smaller sellers and independent fashion businesses online
                can sometimes be difficult.
              </p>

              <p className="mt-4 text-base leading-8 text-[#6f625c]">
                MYSMME was created to help solve that problem by bringing
                customers and sellers together through a dedicated Indian
                fashion marketplace.
              </p>

              <p className="mt-4 text-base leading-8 text-[#6f625c]">
                Our focus begins with sarees because they represent one of the
                most diverse and enduring parts of Indian fashion. Over time,
                our vision is to create a broader marketplace for Indian
                clothing, ethnic fashion, accessories, and related products.
              </p>
              ...
              <div className="mt-8 space-y-4">
                ...
                <StoryPoint>
                  Celebrate India's diverse fashion traditions and
                  craftsmanship.
                </StoryPoint>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-[#6f625c]">
              ...
              and Indian fashion businesses. The goal is to make discovery
              easier for shoppers while creating more opportunities for sellers.
            </p>
          </div>
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-24">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-white/65">
                Customers want choice, discovery, convenience, and confidence
                when shopping online. Sellers want visibility, reach, and a
                digital platform for their products.
              </p>
            ...
            <div className="grid items-stretch lg:grid-cols-[0.8fr_1.2fr]">
              ...
              <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-14">
                ...
                <p className="mt-6 max-w-2xl text-base leading-8 text-[#6f625c]">
                  ...
                  help Indian fashion businesses reach more customers while
                  making product discovery easier for shoppers.
                </p>
                ...
                <p className="mt-4 max-w-2xl text-base leading-8 text-[#6f625c]">
                  Starting with sarees and expanding into broader Indian
                  fashion, MYSMME aims to combine the reach of modern technology
                  with the heritage and diversity of India's fashion industry.
                </p>
