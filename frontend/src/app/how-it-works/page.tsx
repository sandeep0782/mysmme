...
const fullTitle = "How MYSMME Works | Sell & Shop Sarees Online";
const description =
  "See how MYSMME connects saree sellers and shoppers — create an account, list products, get discovered, and manage orders, all in four simple steps.";
...
const QUICK_ANSWERS = [
  {
    ...
    answer:
      "No. MYSMME is designed to help businesses and sellers build their presence and showcase products on a marketplace.",
  },
  {
    question: "What can sellers do on MYSMME?",
    answer:
      "Sellers can create their profile, add products, manage catalogue information, receive orders and manage their marketplace activity.",
  },
  {
    question: "How do customers find products?",
    answer:
      "Customers can browse the MYSMME catalogue, explore categories and discover products from participating sellers.",
  },
  {
    question: "What is the goal of MYSMME?",
    answer:
      "To create a marketplace that makes it easier for businesses to reach customers and for shoppers to discover products from sellers.",
  },
];
...
export default function HowItWorksPage() {
  const howToSchema = {
    ...
    "@type": "HowTo",
    name: "How to sell on MYSMME",
    description:
      "Four simple steps to start selling sarees and fashion products on the MYSMME marketplace.",
  ...
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: QUICK_ANSWERS.map((qa) => ({
      "@type": "Question",
      name: qa.question,
      acceptedAnswer: {
        "@type": "Answer",
      ...
      <main className="min-h-screen overflow-hidden bg-[#fffdf9] text-[#241b18]">
            ...
            <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_.95fr]">
              ...
              <div>
                ...
                <p className="mt-7 max-w-2xl text-base leading-8 text-[#6f625c] sm:text-lg">
                  ...
                  marketplace. List your products, reach customers, manage
                  orders and build your business—all from one platform.
                </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-sm leading-7 text-[#756860] sm:text-base">
              MYSMME connects customers looking for products with businesses
              ready to sell them.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
            <div className="grid gap-14 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 text-sm leading-7 text-[#756860] sm:text-base">
                  We are building MYSMME to make marketplace selling easier,
                  more accessible and more useful for growing businesses.
                </p>
        ...
        <section className="relative overflow-hidden bg-[#241b18]">
          ...
          <div className="relative mx-auto max-w-4xl px-6 py-20 text-center lg:px-8 lg:py-24">
            ...
            <h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
              ...
              <span className="block text-[#e0b96b]">a bigger audience.</span>
            </h2>
  ...
  return (
    <div className="group relative rounded-[2rem] border border-[#eadfd6] bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#6d4535]/8">
      <div className="relative z-10 mb-6 flex items-center justify-between">
        ...
        <span className="text-4xl font-black text-[#eee3dd]">{number}</span>
      </div>
...
function JourneyCard({
  ...
  return (
    <div className="group relative rounded-2xl border border-[#eadfd6] bg-white p-5 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
      ...
      <p className="mt-2 text-sm font-bold leading-5 text-[#332723]">{title}</p>
    </div>
  );
}
    ...
    <div className="relative z-10 flex items-center gap-4 py-3">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-extrabold text-[#241b18]">{title}</h3>
        </div>
