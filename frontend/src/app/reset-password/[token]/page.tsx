                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div className="relative">
                            <Input
                                ...
                                className="pl-10 pr-10 h-11 rounded-xs"
                            />
                        ...
                        <Input
                            ...
                            type="password"
                            className="h-11 rounded-xs border border-gray-300 focus:border-red-500 focus-visible:border-red-500 focus:ring-0 focus-visible:ring-0"
                        />
                        {errors.confirmPassword && <p className="text-red-500 text-sm">{errors.confirmPassword.message}</p>}
                        <Button type="submit" className="h-11 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-xs transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                            Reset Password
                        </Button>
                    </form>
                ) : (
